...
REM Copy files
cat %ALTIBASE_DEV%\src\pd\port\windows\config-files\idConfig.h.Win64 >> %ALTIBASE_DEV%\src\id\idConfig.h
...
cat %ALTIBASE_DEV%\src\pd\port\windows\env64.mk.body >>%ALTIBASE_DEV%\env.mk
echo compile64=^1>>%ALTIBASE_DEV%\vars.mk
echo ALTI_CFG_BITTYPE=64>>%ALTIBASE_DEV%\vars.mk
