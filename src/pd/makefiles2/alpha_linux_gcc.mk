...
#
# CVS Info : $Id: alpha_linux_gcc.mk 26440 2008-06-10 04:02:48Z jdlee $
#
...
ACE_FLAG = -D__ACE_INLINE__ -DACE_LACKS_ACE_TOKEN -DACE_LACKS_ACE_OTHER
EXTRA_CXXOPT	+= $(ACE_FLAG) -O3 -mcpu=ev6 -funroll-all-loops
EXTRA_LOPT	+= -O3 -mcpu=ev6 -funroll-all-loops
else
error:
