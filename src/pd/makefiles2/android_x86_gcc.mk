...
ANDROID_CFLAGS   = -fno-exceptions -fno-rtti -fno-use-cxa-atexit -fno-strict-aliasing -DANDROID
ANDROID_INCLUDES = -I$(HOME)/mydroid/bionic/libm/include \
                   ...
                   -I$(HOME)/mydroid/bionic/libc/arch-x86/include \
                   -I$(HOME)/mydroid/bionic/libc/kernel/common \
                   -I$(HOME)/mydroid/bionic/libc/kernel/arch-x86 \
                   -I$(PD_DIR)/port/iostream

CXX	= i686-unknown-linux-gnu-g++ $(ANDROID_CFLAGS) $(ANDROID_INCLUDES)
CC	= i686-unknown-linux-gnu-gcc $(ANDROID_CFLAGS) $(ANDROID_INCLUDES)
LD	= $(CXX)
...
LFLAGS	= -Wl,--whole-archive -Wl,--no-whole-archive -lc -lstdc++ -lm -Wl,--no-undefined $(HOME)/mydroid/prebuilt/linux-x86/toolchain/i686-unknown-linux-gnu-4.2.1/lib/gcc/i686-unknown-linux-gnu/4.2.1/libgcc.a $(HOME)/mydroid_cupcake/prebuilt/linux-x86/toolchain/i686-unknown-linux-gnu-4.2.1/lib/gcc/i686-unknown-linux-gnu/4.2.1/libgcc_eh.a $(HOME)/mydroid/out/target/product/eee_701/obj/lib/crtend_so.o
