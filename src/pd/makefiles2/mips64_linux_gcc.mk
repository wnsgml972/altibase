...
#
# CVS Info : $Id: eldk_linux_gcc.mk 18262 2006-09-25 00:52:43Z sjkim $
#
...
# 동적 컴파일 옵션 선언
#
EXTRA_CXXOPT  = -mabi=n32
EXTRA_LOPT += $(LIB32_DIRS)

#CXXOPT		= -c -Wall -D_POSIX_PTHREAD_SEMANTICS 
CXXOPT		= -c -D_POSIX_PTHREAD_SEMANTICS -mabi=n32
...
ACE_FLAG = -D__ACE_INLINE__ -DACE_LACKS_ACE_TOKEN -DACE_LACKS_ACE_OTHER
EXTRA_CXXOPT	+= $(ACE_FLAG) -O2 -funroll-loops
EXTRA_LOPT	+= -O2 -funroll-loops -mabi=n32
...
CXXFLAGS	= $(CXXOPT) $(EXTRA_CXXOPT) -mabi=n32
CXXFLAGS2	= $(CXXOPT) $(EXTRA_CXXOPT2) -mabi=n32
