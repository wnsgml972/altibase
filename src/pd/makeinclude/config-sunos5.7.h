...
// common to sunos5.7,5.8. this is necessary for
// gcc 3.1 compiler which do not convert from unsigned int * to int *
#if ! defined(PDL_HAS_SOCKLEN_T)
#define PDL_HAS_SOCKLEN_T
#endif /* ! PDL_HAS_SOCKLEN_T */
