...
/* -*- C++ -*- */
// config-kcc-common.h,v 4.12 1999/11/08 17:07:01 nanbor Exp
...
#ifndef PDL_KCC_COMMON_H
#define PDL_KCC_COMMON_H
...
#define PDL_LACKS_IOSTREAM_FX 1
#define PDL_LACKS_LINEBUFFERED_STREAMBUF 1
#define PDL_LACKS_UNBUFFERED_STREAMBUF 1
