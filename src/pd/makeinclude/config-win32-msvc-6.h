 ...
 *
 *  config-win32-msvc-6.h,v 4.7 2002/05/02 04:08:14 ossama Exp
 *
 *  @brief  Microsoft Visual C++ 6.0 configuration file. 
 *
 *  This file is the PDL configuration file for Microsoft Visual C++ version 6. 
 *
...
#ifndef PDL_CONFIG_WIN32_MSVC_6_H
#define PDL_CONFIG_WIN32_MSVC_6_H
...
# if !defined (PDL_ENDTHREADEX)
#   define PDL_ENDTHREADEX(STATUS) ::_endthreadex ((DWORD) STATUS)
# endif 

#endif /* PDL_CONFIG_WIN32_MSVC_6_H */
