...
/***********************************************************************
 * $Id: mtvFloat2Smallint.cpp 47933 2011-06-30 02:01:37Z et16 $
 **********************************************************************/
...
extern mtvModule mtvFloat2Smallint;
...
IDE_RC mtvCalculate_Float2Smallint( mtcNode*     aNode,
                                    mtcStack*    aStack,
                                    SInt         aRemain,
                                    void*        aInfo,
                                    mtcTemplate* aTemplate );

mtvModule mtvFloat2Smallint = {
    &mtdSmallint,
    &mtdFloat,
...
IDE_RC mtvCalculate_Float2Smallint( mtcNode*,
                                  mtcStack*    aStack,
                                  SInt,
                                  void*,
                                  mtcTemplate* )
