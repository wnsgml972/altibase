...
/* PROJ-1755 */
extern mtlNCRet mtlMS936NextChar( UChar ** aSource, UChar * aFence );

static SInt mtlMS936MaxPrecision( SInt aLength );
...
mtlNCRet mtlMS936NextChar( UChar ** aSource, UChar * aFence )
{
/***********************************************************************
 *
