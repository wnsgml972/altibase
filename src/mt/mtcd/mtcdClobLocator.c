...
/***********************************************************************
 * $Id: mtcdClobLocator.cpp 16552 2006-06-07 02:29:08Z mhjeong $
 **********************************************************************/
...
#define MTD_CLOB_LOCATOR_ALIGN             ( (acp_sint32_t) sizeof(mtdClobLocatorType) )
#define MTD_CLOB_LOCATOR_PRECISION_DEFAULT (1)


static mtdClobLocatorType mtdClobLocatorNull = MTD_CLOB_LOCATOR_NULL;

static ACI_RC mtdInitializeClobLocator( acp_uint32_t aNo );
...
static mtcName mtdTypeName[1] = {
    { NULL, 12, (void*)"CLOB_LOCATOR" }
};

static mtcColumn mtdColumn;

mtdModule mtcdClobLocator = {
    mtdTypeName,
    &mtdColumn,
    MTD_CLOB_LOCATOR_ID,
    0,
    { 0, 0, 0, 0, 0, 0, 0, 0 },
    MTD_CLOB_LOCATOR_ALIGN,
    MTD_GROUP_MISC|
    MTD_CANON_NEEDLESS|
    MTD_CREATE_DISABLE|
...
ACI_RC mtdInitializeClobLocator( acp_uint32_t aNo )
{
    ACI_TEST( mtdInitializeModule( &mtcdClobLocator, aNo ) != ACI_SUCCESS );
                    ...
                    acp_sint32_t* aScale )
{
    ...
    *aColumnSize = sizeof(mtdClobLocatorType);
                            ...
                            acp_uint32_t     aTemp3 )
{
    ...
    ACP_UNUSED(aTemp2);
    ACP_UNUSED(aTemp3);
    return sizeof(mtdClobLocatorType);
}
...
void mtdNull( const mtcColumn* aColumn,
              ...
              acp_uint32_t     aFlag )
{
    mtdClobLocatorType* sValue;

    ACP_UNUSED(aColumn);
    ACP_UNUSED(aRow);
    ACP_UNUSED(aFlag);
    
    sValue = (mtdClobLocatorType*)
...
acp_bool_t mtdIsNull( const mtcColumn* aColumn,
                      ...
                      acp_uint32_t     aFlag )
{
    const mtdClobLocatorType* sValue;

    ACP_UNUSED( aColumn);
    
    sValue = (const mtdClobLocatorType*)
        mtdValueForModule( NULL,
                           aRow, 
                           aFlag,
                           mtcdClobLocator.staticNull );
...
void mtdEndian( void* aValue )
{
    ...
    sLength = (acp_uint8_t*)(mtdClobLocatorType*)aValue;  // smLobLocaotr is ULong
 ...
 ***********************************************************************/
    ...
    ACI_TEST_RAISE( aValueSize != sizeof(mtdClobLocatorType),
                    ERR_INVALID_LENGTH );
 ...
 *******************************************************************/
    ...
    sValue = (mtdClobLocatorType*)aDestValue;
