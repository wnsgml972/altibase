...
/***********************************************************************
 * $Id: mtdByte.cpp 82075 2018-01-17 06:39:52Z jina.kim $
 **********************************************************************/
...
static SInt mtdByteLogicalAscComp( mtdValueInfo * aValueInfo1,
                                   mtdValueInfo * aValueInfo2 );

static SInt mtdByteLogicalDescComp( mtdValueInfo * aValueInfo1,
                                    mtdValueInfo * aValueInfo2 );

static SInt mtdByteFixedMtdFixedMtdKeyAscComp( mtdValueInfo * aValueInfo1,
                                               mtdValueInfo * aValueInfo2 );

static SInt mtdByteFixedMtdFixedMtdKeyDescComp( mtdValueInfo * aValueInfo1,
                                                mtdValueInfo * aValueInfo2 );

static SInt mtdByteMtdMtdKeyAscComp( mtdValueInfo * aValueInfo1,
                                     mtdValueInfo * aValueInfo2 );

static SInt mtdByteMtdMtdKeyDescComp( mtdValueInfo * aValueInfo1,
                                      mtdValueInfo * aValueInfo2 );

static SInt mtdByteStoredMtdKeyAscComp( mtdValueInfo * aValueInfo1,
                                        mtdValueInfo * aValueInfo2 );

static SInt mtdByteStoredMtdKeyDescComp( mtdValueInfo * aValueInfo1,
                                         mtdValueInfo * aValueInfo2 );

static SInt mtdByteStoredStoredKeyAscComp( mtdValueInfo * aValueInfo1,
                                           mtdValueInfo * aValueInfo2 );

static SInt mtdByteStoredStoredKeyDescComp( mtdValueInfo * aValueInfo1,
                                            mtdValueInfo * aValueInfo2 );
...
mtdModule mtdByte = {
    ...
    mtd::isTrueNA,
    {
        mtdByteLogicalAscComp,     // Logical Comparison
        mtdByteLogicalDescComp
    },
    {
        // Key Comparison
        {
            // mt value들 간의 compare
            mtdByteFixedMtdFixedMtdKeyAscComp, // Ascending Key Comparison
            mtdByteFixedMtdFixedMtdKeyDescComp // Descending Key Comparison
        }
        ,
        {
            // mt value들 간의 compare
        ...
        ,
        {
            ...
            mtdByteFixedMtdFixedMtdKeyAscComp,
            mtdByteFixedMtdFixedMtdKeyDescComp
        }
        ,
        {
            /* PROJ-2433 : index Direct key와 mt value들 간의 compare */
            mtdByteMtdMtdKeyAscComp,
            mtdByteMtdMtdKeyDescComp
        }
    },
    mtdCanonize,
    mtdEndian,
...
{
    IDE_TEST( mtd::initializeModule( &mtdByte, aNo ) != IDE_SUCCESS );
                    ...
                    SInt * /*aScale*/ )
{
    ...
    IDE_TEST_RAISE( *aPrecision < MTD_BYTE_PRECISION_MINIMUM ||
                 ...
                 IDE_RC*      aResult )
{
    ...
    sValueOffset = idlOS::align( *aValueOffset, MTD_BYTE_ALIGN );
              ...
              const void*      aRow )
{
    return mtc::hashSkipWithoutZero( aHash,
                                     ((mtdByteType*)aRow)->value,
                                     ((mtdByteType*)aRow)->length );
}
...
SInt mtdByteLogicalAscComp( mtdValueInfo * aValueInfo1,
                            mtdValueInfo * aValueInfo2 )
{
/***********************************************************************
 *
...
SInt mtdByteLogicalDescComp( mtdValueInfo * aValueInfo1,
                             mtdValueInfo * aValueInfo2 )
{
/***********************************************************************
 *
...
SInt mtdByteFixedMtdFixedMtdKeyAscComp( mtdValueInfo * aValueInfo1,
                                        mtdValueInfo * aValueInfo2 )
{
/***********************************************************************
 *
...
SInt mtdByteFixedMtdFixedMtdKeyDescComp( mtdValueInfo * aValueInfo1,
                                         mtdValueInfo * aValueInfo2 )
{
/***********************************************************************
 *
...
SInt mtdByteMtdMtdKeyAscComp( mtdValueInfo * aValueInfo1,
                              mtdValueInfo * aValueInfo2 )
{
/***********************************************************************
 *
...
SInt mtdByteMtdMtdKeyDescComp( mtdValueInfo * aValueInfo1,
                               mtdValueInfo * aValueInfo2 )
{
/***********************************************************************
 *
...
SInt mtdByteStoredMtdKeyAscComp( mtdValueInfo * aValueInfo1,
                                 mtdValueInfo * aValueInfo2 )
{
/***********************************************************************
 *
...
SInt mtdByteStoredMtdKeyDescComp( mtdValueInfo * aValueInfo1,
                                  mtdValueInfo * aValueInfo2 )
{
/***********************************************************************
 *
...
SInt mtdByteStoredStoredKeyAscComp( mtdValueInfo * aValueInfo1,
                                    mtdValueInfo * aValueInfo2 )
{
/***********************************************************************
 *
...
SInt mtdByteStoredStoredKeyDescComp( mtdValueInfo * aValueInfo1,
                                     mtdValueInfo * aValueInfo2 )
{
/***********************************************************************
 *
                           ...
                           mtcTemplate     * /* aTemplate */ )
{
    ...
    else
    {
        ...
        if( mtdByte.isNull( aColumn, sValue ) == ID_TRUE )
        {
            sCanonized->length = 0;
        }
        else
 ...
 *******************************************************************/
    ...
    return mtdActualSize( NULL, &mtdByteNull );
}
