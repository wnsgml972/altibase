...
/***********************************************************************
 * $Id: mtdClobLocator.cpp 16552 2006-06-07 02:29:08Z mhjeong $
 **********************************************************************/
...
#define MTD_CLOB_LOCATOR_ALIGN             ( (SInt) ID_SIZEOF(mtdClobLocatorType) )
...
{
    IDE_TEST( mtd::initializeModule( &mtdClobLocator, aNo ) != IDE_SUCCESS );
                    ...
                    SInt * /*aScale*/ )
{
    ...
    *aColumnSize = ID_SIZEOF(mtdClobLocatorType);
...
UInt mtdActualSize( const mtcColumn*,
                    const void* )
{
    return ID_SIZEOF(mtdClobLocatorType);
}
                 ...
                 void*            aRow )
{
    if ( aRow != NULL )
    {
        *(mtdClobLocatorType*)aRow = MTD_CLOB_LOCATOR_NULL;
    }
}
...
idBool mtdIsNull( const mtcColumn* ,
                  const void*      aRow )
{
    return ( *(mtdClobLocatorType*)aRow == MTD_BLOB_LOCATOR_NULL ) ? ID_TRUE : ID_FALSE;
}
...
void mtdEndian( void* aValue )
{
    ...
    sLength = (UChar*)(mtdClobLocatorType*)aValue;  // smLobLocaotr is ULong
 ...
 ***********************************************************************/
    ...
    IDE_TEST_RAISE( aValueSize != ID_SIZEOF(mtdClobLocatorType),
                    ERR_INVALID_LENGTH );
