...
static IDE_RC mmmPhaseActionBeginPreProcess(mmmPhase         /*aPhase*/,
                                            UInt             /*aOptionflag*/,
                                            mmmPhaseAction * /*aAction*/)
{
    ...
    {
        ideSetCallbackMessage(mmtAdminManager::sendMsgPreProcess); // BUGBUG : 필요없음.
    }
...
mmmPhaseAction gMmmActBeginPreProcess =
{
    (SChar *)"Setup BeginPreProcess..",
    MMM_ACTION_NO_LOG,
    mmmPhaseActionBeginPreProcess
};
