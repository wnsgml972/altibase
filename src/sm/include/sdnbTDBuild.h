...
/***********************************************************************
 * $Id: sdnIndexBuildTopDownThread.h 13951 2005-10-17 00:59:25Z xcom73 $
 *
 * Description :
 *
 * Buffer Flush 쓰레드
...
#ifndef _O_SDNB_TDBUILD_H_
#define _O_SDNB_TDBUILD_H_ 1
...
class sdnbTDBuild : public idtBaseThread
{
public:
