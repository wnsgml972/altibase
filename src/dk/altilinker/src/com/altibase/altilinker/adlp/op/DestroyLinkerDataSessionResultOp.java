...
public class DestroyLinkerDataSessionResultOp extends ResultOperation
{
    public DestroyLinkerDataSessionResultOp()
    {
        super(OpId.DestroyLinkerDataSessionResult, false);
    }
