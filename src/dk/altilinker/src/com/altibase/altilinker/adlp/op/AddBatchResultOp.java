...
public class AddBatchResultOp extends ResultOperation
{
    public long mRemoteStatementId = 0;
    public int mProcessedBatchCount = 0;
    
    public AddBatchResultOp()
    {
        super(OpId.AddBatchResult, true);
    }
                                     ...
                                     ByteBuffer   aOpPayload)
    {
        ...
        try
        {
            if (canWriteData() == true)
            {
                ...
                writeInt(aOpPayload, mProcessedBatchCount);
            }
        }
