...
public class RequestLinkerDumpResultOp extends ResultOperation
{
    public int mLinkerDump = 0;
    
    public RequestLinkerDumpResultOp()
    {
        super(OpId.RequestLinkerDumpResult, false);
    }
                                     ...
                                     ByteBuffer   aOpPayload)
    {
        ...
        try
        {
            ...
            {
                // write data
                writeInt(aOpPayload, mLinkerDump);
            }
        }
