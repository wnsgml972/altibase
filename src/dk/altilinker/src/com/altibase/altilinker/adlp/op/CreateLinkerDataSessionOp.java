...
public class CreateLinkerDataSessionOp extends RequestOperation
{
    public CreateLinkerDataSessionOp()
    {
        super(OpId.CreateLinkerDataSession, false);
    }

    public ResultOperation newResultOperation()
    {
        return new CreateLinkerDataSessionResultOp();
    }
