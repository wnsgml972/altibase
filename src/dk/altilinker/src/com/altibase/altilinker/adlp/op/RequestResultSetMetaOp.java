...
public class RequestResultSetMetaOp extends RequestOperation
{
    public long mRemoteStatementId = 0;
    
    public RequestResultSetMetaOp()
    {
        super(OpId.RequestResultSetMeta, true);
    }

    public ResultOperation newResultOperation()
    {
        return new RequestResultSetMetaResultOp();
    }
