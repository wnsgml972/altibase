...
public class XAForgetResultOp extends ResultOperation
{   
    public LinkedList   mFailXidList   = new LinkedList();
    
    // ... Count of XIDs (4)    XID1 (152)  ...Err Code XID2 (152)  Err Code
    
    public XAForgetResultOp()
    {
        super(OpId.XAForgetResult, false);
    }
