...
public class RequestRemoteErrorInfoOp extends RequestOperation
{
    public long mRemoteStatementId = 0;
    
    public RequestRemoteErrorInfoOp()
    {
        super(OpId.RequestRemoteErrorInfo, true);
    }

    public ResultOperation newResultOperation()
    {
        return new RequestRemoteErrorInfoResultOp();
    }
