...
public class RequestFreeRemoteStatementResultOp extends ResultOperation
{
    public long  mRemoteStatementId   = 0;
    public short mRemoteNodeSessionId = 0;
    
    public RequestFreeRemoteStatementResultOp()
    {
        super(OpId.RequestFreeRemoteStatementResult, true);
    }
