...
public class PrepareRemoteStatementOp extends RequestOperation
{
    ...
    public PrepareRemoteStatementOp()
    {
        super(OpId.PrepareRemoteStatement, true, true);
    }
    
    public ResultOperation newResultOperation()
    {
        return new PrepareRemoteStatementResultOp();
    }
