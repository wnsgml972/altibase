...
public class RequestFreeRemoteStatementOp extends RequestOperation
{
    public long mRemoteStatementId = 0;
    
    public RequestFreeRemoteStatementOp()
    {
        super(OpId.RequestFreeRemoteStatement, true);
    }

    public ResultOperation newResultOperation()
    {
        return new RequestFreeRemoteStatementResultOp();
    }
