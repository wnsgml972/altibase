...
public class RequestLinkerStatusOp extends RequestOperation
{
    public RequestLinkerStatusOp()
    {
        super(OpId.RequestLinkerStatus, false);
    }

    public ResultOperation newResultOperation()
    {
        return new RequestLinkerStatusResultOp();
    }
