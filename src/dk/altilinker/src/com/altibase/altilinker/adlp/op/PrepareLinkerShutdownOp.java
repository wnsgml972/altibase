...
public class PrepareLinkerShutdownOp extends RequestOperation
{
    public PrepareLinkerShutdownOp()
    {
        super(OpId.PrepareLinkerShutdown, false);
    }

    public ResultOperation newResultOperation()
    {
        return new PrepareLinkerShutdownResultOp();
    }
