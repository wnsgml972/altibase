...
public class RequestCloseRemoteNodeSessionResultOp extends ResultOperation
{
    public short mRemoteNodeSessionId            = 0;
    public int   mRemainedRemoteNodeSessionCount = 0;
    
    public RequestCloseRemoteNodeSessionResultOp()
    {
        super(OpId.RequestCloseRemoteNodeSessionResult, true);
    }
                                     ...
                                     ByteBuffer   aOpPayload)
    {
        ...
        try
        {
            if (canWriteData() == true)
            {
                ...
                writeInt  (aOpPayload, mRemainedRemoteNodeSessionCount);
            }
        }
