...
public class RequestFreeRemoteStatementBatchResultOp extends ResultOperation
{
    public long  mRemoteStatementId   = 0;
    
    public RequestFreeRemoteStatementBatchResultOp()
    {
        super(OpId.RequestFreeRemoteStatementBatchResult, true);
    }
