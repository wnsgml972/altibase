...
public class PrepareRemoteStatementBatchOp extends RequestOperation
{
    ...
    public PrepareRemoteStatementBatchOp()
    {
        super(OpId.PrepareRemoteStatementBatch, true, true);
    }
    
    public ResultOperation newResultOperation()
    {
        return new PrepareRemoteStatementBatchResultOp();
    }

    protected boolean isFragmented(CommonHeader aCommonHeader)
    {
        boolean sFragmented = (aCommonHeader.getOpSpecificParameter() != 0) ? true : false;
