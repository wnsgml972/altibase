...
public class AbortRemoteStatementOp extends RequestOperation
{
    public long mRemoteStatementId = 0;
    
    public AbortRemoteStatementOp()
    {
        super(OpId.AbortRemoteStatement, true);
    }
    
    public ResultOperation newResultOperation()
    {
        return new AbortRemoteStatementResultOp();
    }
