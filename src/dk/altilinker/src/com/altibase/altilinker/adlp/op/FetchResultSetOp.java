...
public class FetchResultSetOp extends RequestOperation
{
    public long mRemoteStatementId = 0;
    public int  mFetchRowCount     = 0;
    public int  mBufferSize        = 0;

    public FetchResultSetOp()
    {
        super(OpId.FetchResultSet, true);
    }

    public ResultOperation newResultOperation()
    {
        return new FetchResultRowOp();
    }
                                    ...
                                    ByteBuffer   aOpPayload)
    {
        ...
        if (aCommonHeader.getDataLength() > 0)
        {
            try
            {
                ...
                mFetchRowCount     = readInt (aOpPayload);
                mBufferSize        = readInt (aOpPayload);
            }
