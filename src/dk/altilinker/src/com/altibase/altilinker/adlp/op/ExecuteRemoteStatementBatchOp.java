...
public class ExecuteRemoteStatementBatchOp extends RequestOperation
{
    public long mRemoteStatementId = 0;
    
    public ExecuteRemoteStatementBatchOp()
    {
        super(OpId.ExecuteRemoteStatementBatch, true);
    }

    public ResultOperation newResultOperation()
    {
        return new ExecuteRemoteStatementBatchResultOp();
    }
