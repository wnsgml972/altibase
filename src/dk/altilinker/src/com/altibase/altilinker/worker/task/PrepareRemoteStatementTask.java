...
public class PrepareRemoteStatementTask extends Task
{
    ...
    public PrepareRemoteStatementTask()
    {
        super(TaskType.PrepareRemoteStatement);
    }
    ...
    public void setOperation(Operation aOperation)
    {
        ...
        PrepareRemoteStatementOp sRequestOperation = (PrepareRemoteStatementOp)aOperation;
    ...
    public void run()
    {
        ...
        PrepareRemoteStatementResultOp sResultOperation =
                (PrepareRemoteStatementResultOp)newResultOperation();
    ...
    private static void setFetchSize( PreparedStatement aPreparedStatement,
                                      int               aFetchSize )
    {
        try 
        {
            aPreparedStatement.setFetchSize( aFetchSize );
        }
        ...
        {   
            ...
            {
                setFetchSize( aPreparedStatement,
                              Short.MAX_VALUE - 1 );
            }
