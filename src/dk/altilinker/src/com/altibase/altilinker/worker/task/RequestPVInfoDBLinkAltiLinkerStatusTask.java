...
public class RequestPVInfoDBLinkAltiLinkerStatusTask extends Task
{
    public RequestPVInfoDBLinkAltiLinkerStatusTask()
    {
        super(TaskType.RequestPVInfoDBLinkAltiLinkerStatus);
    }
    ...
    public void run()
    {
        ...
        RequestPVInfoDBLinkAltiLinkerStatusResultOp sResultOperation =
                (RequestPVInfoDBLinkAltiLinkerStatusResultOp)newResultOperation();
        ...
        sResultOperation.mRemoteNodeSessionCount =
                sSessionManager.getRemoteNodeSessionCount();

        long sTotalMemory = Runtime.getRuntime().totalMemory();
        long sFreeMemory  = Runtime.getRuntime().freeMemory();
        sResultOperation.mJvmMemoryPoolUsage = sTotalMemory - sFreeMemory;
