...
public class RequestFreeRemoteStatementTask extends Task
{
    protected long mRemoteStatementId = 0;
    
    public RequestFreeRemoteStatementTask()
    {
        super(TaskType.RequestFreeRemoteStatement);
    }
    ...
    public void setOperation(Operation aOperation)
    {
        ...
        RequestFreeRemoteStatementOp sRequestOperation =
                (RequestFreeRemoteStatementOp)aOperation;
    ...
    public void run()
    {
        ...
        RequestFreeRemoteStatementResultOp sResultOperation =
                (RequestFreeRemoteStatementResultOp)newResultOperation();
