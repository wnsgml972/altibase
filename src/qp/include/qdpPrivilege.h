...
/***********************************************************************
 * $Id: qdpPrivilege.h 82075 2018-01-17 06:39:52Z jina.kim $
 **********************************************************************/
#ifndef  _O_QDP_PRIVILEGE_H_
#define  _O_QDP_PRIVILEGE_H_  1
...
public:
    ...
    // PROJ-1359 Trigger
    static IDE_RC checkDDLCreateTriggerPriv( qcStatement   * aStatement,
                                             UInt            aTriggerOwnerID);

    // To Fix PR-10618
    static IDE_RC checkDDLCreateTriggerTablePriv( qcStatement * aStatement,
                                                  UInt          aTableOwnerID);
    ...
    // PROJ-1359 Trigger
    static IDE_RC checkDDLDropTriggerPriv( qcStatement   * aStatement,
                                           UInt            aTriggerOwnerID);
    ...
    static IDE_RC checkSystemPrivAllAndPublic(
        qcStatement    * aStatement,
        UInt             aGranteeID,
        UInt             aPrivID,
        idBool         * aExist);

    static IDE_RC checkDDLCreateDatabasePriv(
        qcStatement    * aStatement,
        UInt             aUserID);

    static IDE_RC checkDDLAlterDatabasePriv(
        qcStatement    * aStatement,
        UInt             aUserID);

    static IDE_RC checkDDLDropDatabasePriv(
        qcStatement    * aStatement,
        UInt             aUserID);
...
private:
    ...
    static IDE_RC checkSystemPrivilege( qcStatement * aStatement,
                                        UInt          aGrantorID,
                                        UInt          aPrivilegeId,
                                        idBool      * aExist );
};

#endif // _O_QDP_PRIVILEGE_H_
