...
#ifndef _O_IDU_SHM_MEMLIST_H_
#define _O_IDU_SHM_MEMLIST_H_ 1
...
typedef struct iduStShmMemSlot
{
    idShmAddr   mAddrSelf;
    idShmAddr   mAddrNext;
} iduStShmMemSlot;

typedef struct iduStShmMemChunk
{
    idShmAddr     mAddrSelf;
    idShmAddr     mAddrParent;
    idShmAddr     mAddrNext;
    idShmAddr     mAddrPrev;
    idShmAddr     mAddrTop;
...
typedef struct iduStShmMemList
{
    idShmAddr            mAddrSelf;
    UInt                 mSequence;
    iduShmLatch          mLatch;

    iduStShmMemChunk     mFreeChunk;
    iduStShmMemChunk     mPartialChunk;
    iduStShmMemChunk     mFullChunk;
...
class iduShmMemList
{
    friend class iduShmMemPool;
    friend void iduCheckMemConsistency( iduStShmMemList *aMemList );
...
inline void iduShmMemList::unlink( iduShmTxInfo      * aShmTxInfo,
                                   iduStShmMemChunk  * aChunk )
{
...
inline void iduShmMemList::link( iduShmTxInfo         * aShmTxInfo,
                                 iduStShmMemChunk     * aBefore,
                                 iduStShmMemChunk     * aChunk )
{
    iduStShmMemChunk *sAfter =
