...
static const UShort uhc_1_2uni_main_page81[64] = {
...
static const UChar uhc_1_2uni_page81[5696] = {
  /* 0x81 */
...
static const UShort uhc_1_2charset_main[45] = {
...
static const UChar uhc_1_2charset[5696] = {
  0x1d, 0x1c, 0x1f, 0x1e, 0x19, 0x18, 0x1b, 0x1a,
  0x15, 0x14, 0x17, 0x16, 0x11, 0x10, 0x13, 0x12,
  0x0d, 0x0c, 0x0f, 0x0e, 0x09, 0x08, 0x0b, 0x0a,
        ...
        if (aSrcRemain >= 2)
        {
                ...
                (sSrcCharPtr[1] >= 0x81 && sSrcCharPtr[1] < 0xff) )
            {
                ...
                if (i < 5696)
                {
                    ...
                    {
                        wc = (UShort) ( (uhc_1_2uni_main_page81[sIndex] ^ UHC1_XOR_VALUE) +
