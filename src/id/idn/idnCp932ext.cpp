...
static const UShort gCp932Ext2UniPage87[ 92 ] = {
...
static const UShort gCp932Ext2UniPageed[ 376 ] = {
...
static const UShort gCp932Ext2UniPagefa[ 388 ] = {
        ...
        else
        {
                 ...
                 ( sSrcPtr[ 1 ] >= 0x80 && sSrcPtr[ 1 ] < 0xfd ) )
            {
                ...
                if ( sNum < 8272 )
                {
                    if ( sNum < 1220 )
                    {
                        sWideChar = gCp932Ext2UniPage87[ sNum - 1128 ]
                                    ^ IDN_CP932EXT_XOR_VALUE;
                    }
                    else
                    {
                        // Nothing to do
                ...
                else if ( sNum < 10716 )
                {
                    if ( sNum < 8648 )
                    {
                        sWideChar = gCp932Ext2UniPageed[ sNum - 8272 ]
                                    ^ IDN_CP932EXT_XOR_VALUE;
                    }
                    else
                    {
                ...
                else
                {
                    if ( sNum < 11104 )
                    {
                        sWideChar = gCp932Ext2UniPagefa[ sNum - 10716 ]
                                    ^ IDN_CP932EXT_XOR_VALUE;
                    }
                    else
                    {
...
static const UShort gCp932Ext2Charset[ 457 ] = {
...
static const Summary16 gCp932ExtUni2IndexPage21[ 28 ] = {
    /* 0x2100 */
...
static const Summary16 gCp932ExtUni2IndexPage24[ 8 ] = {
    /* 0x2400 */
...
/* 0x3000 */
static const Summary16 gCp932ExtUni2IndexPage30[ 2 ] = {
    {   55, 0x0000 }, {   55, 0xa000 }
};

static const Summary16 gCp932ExtUni2IndexPage32[ 29 ] = {
    /* 0x3200 */
...
static const Summary16 gCp932ExtUni2IndexPage4e[ 121 ] = {
    /* 0x4e00 */
...
static const Summary16 gCp932ExtUni2IndexPage57[ 44 ] = {
    /* 0x5700 */
...
static const Summary16 gCp932ExtUni2IndexPage5b[ 46 ] = {
    /* 0x5b00 */
...
static const Summary16 gCp932ExtUni2IndexPage5f[ 458 ] = {
    /* 0x5f00 */
...
static const Summary16 gCp932ExtUni2IndexPage7d[ 43 ] = {
    /* 0x7d00 */
...
static const Summary16 gCp932ExtUni2IndexPage83[ 44 ] = {
    /* 0x8300 */
...
static const Summary16 gCp932ExtUni2IndexPage88[ 109 ] = {
    /* 0x8800 */
...
static const Summary16 gCp932ExtUni2IndexPage90[ 238 ] = {
    /* 0x9000 */
...
static const Summary16 gCp932ExtUni2IndexPagef9[ 19 ] = {
    /* 0xf900 */
...
static const Summary16 gCp932ExtUni2IndexPageff[ 15 ] = {
    /* 0xff00 */
    ...
    else
    {
        ...
        else
        {
            ...
            if ( sUsed & ( (UShort) 1 << sNum ) )
            {
                ...
                sVal = gCp932Ext2Charset[ sSummary->indx + sUsed ]
                       ^ IDN_CP932EXT_XOR_VALUE;
