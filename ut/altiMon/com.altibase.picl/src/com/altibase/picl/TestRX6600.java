...
public class TestRX6600 extends TestCase {
	...
	Picl picl = new Picl();
	ProcCpu pcpu = picl.getProcCpu("init");
    ...
    {
	Picl picl = new Picl();
	assertTrue(picl.getProcMem("init").getUsed()>=0);
    }
    ...
    {
	Picl picl = new Picl();
	assertTrue(picl.getProcFinder().getProcessID("init")==1);
    }
}