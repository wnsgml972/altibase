...
public class TestAIX53TL9 extends TestCase {
	...
	Picl picl = new Picl();
	ProcCpu pcpu = picl.getProcCpu("/etc/init");
    ...
    {
	Picl picl = new Picl();
	assertTrue(picl.getProcMem("/etc/init").getUsed()>=0);
    }
    ...
    {
	Picl picl = new Picl();
	assertTrue(picl.getProcFinder().getProcessID("/etc/init")==1);
    }
}
