...
public class TestT5140 extends TestCase {
	...
	Picl picl = new Picl();
	ProcCpu pcpu = picl.getProcCpu("/sbin/init");
    ...
    {
	Picl picl = new Picl();
	assertTrue(picl.getProcMem("/sbin/init").getUsed()>=0);
    }
    ...
    {
	Picl picl = new Picl();
	assertTrue(picl.getDisk("/sbin").getDirUsage()>=0);
    }
    ...
    {
	Picl picl = new Picl();
	assertTrue(picl.getProcFinder().getProcessID("/sbin/init")==1);
    }
}