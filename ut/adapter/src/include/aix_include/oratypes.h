...
# ifdef __64BIT__
#  define ORAUB8MAXVAL    ((oraub8)18446744073709551615uL)
#  define ORASB8MINVAL    ((orasb8)-9223372036854775808L)
#  define ORASB8MAXVAL    ((orasb8) 9223372036854775807L)
#  define MINORAUB8MAXVAL ((oraub8)18446744073709551615uL)
#  define MAXORASB8MINVAL ((orasb8)-9223372036854775807L)
#  define MINORASB8MAXVAL ((orasb8) 9223372036854775807L)
# else
#  define ORAUB8MAXVAL    ((oraub8)18446744073709551615uLL)
#  define ORASB8MINVAL    ((orasb8)-9223372036854775808LL)
#  define ORASB8MAXVAL    ((orasb8) 9223372036854775807LL)
#  define MINORAUB8MAXVAL ((oraub8)18446744073709551615uLL)
#  define MAXORASB8MINVAL ((orasb8)-9223372036854775807LL)
#  define MINORASB8MAXVAL ((orasb8) 9223372036854775807LL)
# endif
