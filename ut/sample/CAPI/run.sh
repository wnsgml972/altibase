...
echo "========" >> run.out
is -silent -f demo_ex1.sql
./demo_ex1 >> run.out   

echo "========" >> run.out
echo "DEMO EX2" >> run.out
echo "========" >> run.out
is -silent -f demo_ex2.sql
./demo_ex2 >> run.out   

echo "========" >> run.out
echo "DEMO EX3" >> run.out
echo "========" >> run.out
is -silent -f demo_ex3.sql
./demo_ex3 >> run.out   

echo "========" >> run.out
echo "DEMO EX4" >> run.out
echo "========" >> run.out
is -silent -f demo_ex4.sql
./demo_ex4 >> run.out   

echo "========" >> run.out
echo "DEMO EX5" >> run.out
echo "========" >> run.out
is -silent -f demo_ex5.sql
./demo_ex5 >> run.out  

echo "========" >> run.out
echo "DEMO EX6" >> run.out
echo "========" >> run.out
is -silent -f demo_ex6.sql
./demo_ex6 >> run.out

echo "========" >> run.out
echo "DEMO EX7" >> run.out
echo "========" >> run.out
is -silent -f demo_ex7.sql
./demo_ex7 >> run.out
...
echo "==========" >> run.out
is -silent -f demo_meta2.sql
./demo_meta2 >> run.out   

echo "==========" >> run.out
echo "DEMO META8" >> run.out
echo "==========" >> run.out
is -silent -f demo_meta8.sql
./demo_meta8 >> run.out   

echo "==========" >> run.out
echo "DEMO TRAN1" >> run.out
echo "==========" >> run.out
is -silent -f demo_tran1.sql
./demo_tran1 >> run.out   

echo "==========" >> run.out
echo "DEMO TRAN2" >> run.out
echo "==========" >> run.out
is -silent -f demo_tran2.sql
./demo_tran2 >> run.out   
is -silent -f demo_tran2_sel.sql >> run.out
...
echo "==========" >> run.out
is -silent -f demo_clob.sql
./demo_clob >> run.out

echo "==========" >> run.out
echo "DEMO BLOB " >> run.out
echo "==========" >> run.out
is -silent -f demo_blob.sql
./demo_blob >> run.out

make clean
is -silent -f drop_schema.sql

diff run.lst run.out > run.diff

if [ `wc -l run.diff | sed 's/\([0-9]\) .*/\1/'` = "0" ]
then
    echo "PASS"
else
