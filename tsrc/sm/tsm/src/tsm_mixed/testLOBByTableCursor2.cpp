                                     ...
                                     UInt   aMax)
{
    ...
    sValueList[3].value = sLOBColumnValue;
    sValueList[4].value = sLOBColumnValue;

    idlOS::fprintf(
        TSM_OUTPUT,
        "testLOBInterface: Insert Test Begin: size is %d(byte)\n",
        aLobColumnValueSize);
    ...
    sValueList[3].length = aLobColumnValueSize;
    sValueList[4].length = aLobColumnValueSize;
                                     ...
                                     UInt   aMax)
{
    ...
    idlOS::fprintf( TSM_OUTPUT,
                    "testLOBInterface: Update Test Begin: x into %d(Byte) Size(%u, %u)\n",
                    aLobColumnValueSize,
                    aMin,
                    aMax);
